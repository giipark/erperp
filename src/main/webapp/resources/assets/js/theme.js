				...
				'<div class="center-sign">',
					'<div class="panel panel-sign">',
						'<div class="panel-body">',
								'<form>',
								'<div class="current-user text-center" style="margin-top: 30px;">',											
									'<h2  class="user-name text-dark m-none" style="line-height:0.6rem">정보 변경</h2>',
														
									'<img id="LockUserPicture" src="{{picture}}" alt="John Doe" class="img-circle user-image"  style="display:none" />',
									'<h2 id="LockUserName" class="user-name text-dark m-none" style="display:none" >{{username}}</h2>',
									'<p  id="LockUserEmail" class="user-email m-none" style="display:none">{{email}}</p>',								   								   								  
								...
								'<div class="input-group input-group-icon">',
									'<input id="update_userid" name="userid" type="text" class="form-control input-lg" placeholder="아이디" />',
								...
								'<div class="form-group mb-lg">',
								'<div class="input-group input-group-icon">',
									'<input id="update_username" name="username" type="text" class="form-control input-lg" placeholder="이름" />',
									'<span class="input-group-addon">',
										'<span class="icon icon-lg">',
								...
								'<div class="form-group mb-lg">',
									'<div class="input-group input-group-icon">',
										'<input id="update_userpw" name="userpw" type="password" class="form-control input-lg" placeholder="비밀번호" />',
										'<span class="input-group-addon">',
											'<span class="icon icon-lg">',
												'<i class="fa fa-key"></i>',
											'</span>',
								...
								'<div class="form-group mb-lg">',
								'<div class="input-group input-group-icon">',
									'<input id="update_userpw_check" name="pwck" type="password" class="form-control input-lg" placeholder="비밀번호 확인" />',
									'<span class="input-group-addon">',
										'<span class="icon icon-lg">',
											'<i class="fa fa-key"></i>',
										'</span>',
								...
								'<div class="row">',
									'<div class="col-xs-6">',
										'<p class="mt-xs mb-none">',
											'<button type="button" class="btn btn-success" onclick="cUpdateInfoAjax()">정보변경</button>',
										'</p>',
									'</div>',
									'<div class="col-xs-6 text-right">',
										'<button type="button" class="btn btn-primary" onclick="cInfoClose()" data-lock-screen="false" >닫기</button>',
									'</div>',
								'</div>',
								'</form>',
						'</div>',
